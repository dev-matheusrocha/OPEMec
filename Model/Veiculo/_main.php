...
class ServiceVeiculo{
	...
	public function inserirVeiculo(){
		...
		$quary = " SELECT VeiculoId FROM `Veiculo` 
		WHERE VeiculoPlaca = ? and ClienteId = ? ";
...
function veiculosCliente($texto){
	...
	select($resultado, "Selecionar veiculo", array("VeiculoPlaca") , "Selecione o veiculo", "VeiculoId", "btn-outline-primary", "VeiculoId", "");

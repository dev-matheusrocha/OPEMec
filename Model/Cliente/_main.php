...
function pesquisarCliente($obj){;
	...
	select($resultado, "Dono(a): ", array('ClienteNome', 'ClienteCpfCnpj'), "Selecione um dono(a)", "selectcliente", "btn-outline-primary", "ClienteId", 'listarVeiculo()');
}
